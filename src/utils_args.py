...
class ModelArguments:
    ...
    mult_std: Optional[int] = field(
        default=1,
        metadata={
            "help": "Multiplier of the coefficients of linear combination of activations from different loras."
        },
    )
    ...
    activations_regularizing_weight: Optional[float] = field(
        default=1.0,
        metadata={"help": "Activations regularization loss weight."},
    )
    shift_regularizing_weight: Optional[float] = field(
        default=1.0,
        metadata={"help": "Activations shifts regularization loss weight."},
    )
